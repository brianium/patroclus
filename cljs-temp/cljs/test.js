...
var G__10530 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10530,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10530;
}
}));
...
var len__4789__auto___10535 = arguments.length;
var i__4790__auto___10536 = (0);
while(true){
if((i__4790__auto___10536 < len__4789__auto___10535)){
args__4795__auto__.push((arguments[i__4790__auto___10536]));

var G__10537 = (i__4790__auto___10536 + (1));
i__4790__auto___10536 = G__10537;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10532){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10533,G__10534,seq10532__$2);
}));
...
var file = cljs.core.get.call(null,map__10539__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10539__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10539__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__10538_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10538_SHARP_));
...
var temp__5735__auto___10541 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___10541)){
var message_10542 = temp__5735__auto___10541;
cljs.core.println.call(null,message_10542);
} else {
}
...
var temp__5735__auto___10543 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___10543)){
var message_10544 = temp__5735__auto___10543;
cljs.core.println.call(null,message_10544);
} else {
}
...
var output_dir = "cljs-temp";
var output_dir__$1 = (function (){var G__10545 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__10545,"/"].join('');
} else {
return G__10545;
}
})();
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__10547 = exception.stack;
var G__10547__$1 = (((G__10547 == null))?null:clojure.string.split_lines.call(null,G__10547));
var G__10547__$2 = (((G__10547__$1 == null))?null:cljs.core.get.call(null,G__10547__$1,depth));
if((G__10547__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__10547__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__10548 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__10548,(0),null);
var column = cljs.core.nth.call(null,vec__10548,(1),null);
var vec__10551 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__10551,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__10551,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__10551,(2),null);
...
var m__$1 = (function (){var G__10554 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__10554__$1 = (((G__10554 instanceof cljs.core.Keyword))?G__10554.fqn:null);
switch (G__10554__$1) {
case "fail":
...
var G__10558 = (function (){var G__10557 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__10557);
} else {
return G__10557;
}
})();
...
return cljs.core.vary_meta.call(null,G__10559,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__10563 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__10563,(0),null);
var types = vec__10563;
...
return cljs.core.map.call(null,(function (p__10566){
var vec__10567 = p__10566;
var ns = cljs.core.nth.call(null,vec__10567,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__10567,(1),null);
return (function (){
...
var G__10570 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__10570__$1 = (((G__10570 instanceof cljs.core.Keyword))?G__10570.fqn:null);
switch (G__10570__$1) {
case "async":
...
var seq__10571 = cljs.core.seq.call(null,vars__$1);
var chunk__10572 = null;
var count__10573 = (0);
var i__10574 = (0);
while(true){
if((i__10574 < count__10573)){
var v = cljs.core._nth.call(null,chunk__10572,i__10574);
var temp__5735__auto___10576 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___10576)){
var t_10577 = temp__5735__auto___10576;
each_fixture_fn.call(null,((function (seq__10571,chunk__10572,count__10573,i__10574,t_10577,temp__5735__auto___10576,v,each_fixture_fn,G__10570,G__10570__$1,env,once_fixtures,each_fixtures,vec__10567,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10577)));
});})(seq__10571,chunk__10572,count__10573,i__10574,t_10577,temp__5735__auto___10576,v,each_fixture_fn,G__10570,G__10570__$1,env,once_fixtures,each_fixtures,vec__10567,ns,vars__$1))
);
} else {
}


var G__10578 = seq__10571;
var G__10579 = chunk__10572;
var G__10580 = count__10573;
var G__10581 = (i__10574 + (1));
seq__10571 = G__10578;
chunk__10572 = G__10579;
count__10573 = G__10580;
i__10574 = G__10581;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq.call(null,seq__10571);
if(temp__5735__auto__){
var seq__10571__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__10571__$1)){
var c__4609__auto__ = cljs.core.chunk_first.call(null,seq__10571__$1);
var G__10582 = cljs.core.chunk_rest.call(null,seq__10571__$1);
var G__10583 = c__4609__auto__;
var G__10584 = cljs.core.count.call(null,c__4609__auto__);
var G__10585 = (0);
seq__10571 = G__10582;
chunk__10572 = G__10583;
count__10573 = G__10584;
i__10574 = G__10585;
continue;
} else {
var v = cljs.core.first.call(null,seq__10571__$1);
var temp__5735__auto___10586__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___10586__$1)){
var t_10587 = temp__5735__auto___10586__$1;
each_fixture_fn.call(null,((function (seq__10571,chunk__10572,count__10573,i__10574,t_10587,temp__5735__auto___10586__$1,v,seq__10571__$1,temp__5735__auto__,each_fixture_fn,G__10570,G__10570__$1,env,once_fixtures,each_fixtures,vec__10567,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_10587)));
});})(seq__10571,chunk__10572,count__10573,i__10574,t_10587,temp__5735__auto___10586__$1,v,seq__10571__$1,temp__5735__auto__,each_fixture_fn,G__10570,G__10570__$1,env,once_fixtures,each_fixtures,vec__10567,ns,vars__$1))
);
} else {
}


var G__10588 = cljs.core.next.call(null,seq__10571__$1);
var G__10589 = null;
var G__10590 = (0);
var G__10591 = (0);
seq__10571 = G__10588;
chunk__10572 = G__10589;
count__10573 = G__10590;
i__10574 = G__10591;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10570__$1)].join('')));
